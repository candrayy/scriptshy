...
<html lang="en">
  <head>
    <link rel="icon" href="assets/images/icon.png">
  	<title>Create Data Platform</title>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <div class="shadow p-3 mb-1 bg-white rounded">
            <h1 class="mb-4">Tambah Data Platform</h1>
          <form action="{{ route('simpan-data-platform') }}" method="post">
            {{ csrf_field() }}
              <div class="form-group">
                  <label for="kd_platform" clas="form-label">Kode Platform</label>
                  <input type="text" id="kd_platform" name="kd_platform" class="form-control" placeholder="Masukan Kode Platform" required>
              </div>
              <div class="form-group">
                  <label for="platform" clas="form-label">Nama Platform</label>
                  <input type="text" id="platform" name="platform" class="form-control" placeholder="Masukan Nama Platform" required>
              </div>
              <div class="form-group">
