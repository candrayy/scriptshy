...
<html lang="en">
  <head>
  	<title>Create Data Jenis Konten</title>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <div class="shadow p-3 mb-1 bg-white rounded">
            <h1 class="mb-4">Tambah Data Jenis Konten</h1>
          <form action="{{ route('simpan-data-jenis-konten') }}" method="post">
            {{ csrf_field() }}
              <div class="form-group">
                  <label for="kd_jns_konten" clas="form-label">Kode Jenis Konten</label>
                  <input type="text" id="kd_jns_konten" name="kd_jns_konten" class="form-control" placeholder="Masukan Kode Jenis Konten" required>
              </div>
              <div class="form-group">
                  <label for="jns_konten" clas="form-label">Jenis Konten</label>
                  <input type="text" id="jns_konten" name="jns_konten" class="form-control" placeholder="Masukkan Jenis Konten" required>
              </div>
              <div class="form-group">
