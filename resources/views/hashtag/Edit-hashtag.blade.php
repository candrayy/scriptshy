  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <div class="shadow p-3 mb-1 bg-white rounded">
            <h1 class="mb-4">Ubah Data Hashtag</h1>
          <form action="{{ route('update-data-hashtag',$editHashtag->id) }}" method="post">
            {{ csrf_field() }}
              <div class="form-group">
                  <label for="kd_hashtag" clas="form-label">Kode Hashtag</label>
                  <input type="text" id="kd_hashtag" name="kd_hashtag" value="{{$editHashtag->kd_hashtag}}" class="form-control" placeholder="Masukan Kode Hashtag" required>
              </div>
              <div class="form-group">
                  <label for="hashtag" clas="form-label">Nama Hashtag</label>
                  <input type="text" id="hashtag" name="hashtag" value="{{$editHashtag->hashtag}}" class="form-control" placeholder="Masukan Nama Hashtag" required>
              </div>
              <div class="form-group">
