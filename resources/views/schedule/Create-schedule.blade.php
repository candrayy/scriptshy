  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <div class="shadow p-3 mb-1 bg-white rounded">
            <h1 class="mb-4">Tambah Data Schedule</h1>
          <form action="{{ route('simpan-data-schedule') }}" method="post">
            {{ csrf_field() }}
              ...
              <div class="form-group">
                  ...
                  <input type="text" id="judul_konten" name="judul_konten" class="form-control" placeholder="Masukan Judul Konten" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="datetime-local" id="created_at" name="created_at" class="form-control" value="" min="1990-01-01T00:00" max="2050-01-01T00:00" placeholder="dd-mm-yyyy" required>
              </div>
              <div class="form-group">
                  <label for="updated_at" class="form-label">Updated At</label>
                  <input type="datetime-local" id="updated_at" name="updated_at" class="form-control" value="" min="1990-01-01T00:00" max="2050-01-01T00:00" placeholder="dd-mm-yyyy" required>
              </div>
              <div class="form-group">
