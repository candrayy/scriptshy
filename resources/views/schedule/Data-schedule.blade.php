          ...
          <table class="table table-hover table-bordered" style="height:20px;overflow-y:scroll">
              ...
              @foreach($dtSchedule as $item)
                  <tr>
                      ...
                      <td>
                        <a href="{{ route('edit-data-schedule', $item->id) }}"><span class="fa fa-edit" style="color: limegreen"></span></a>
                        |
                        <a href="{{ route('delete-data-schedule', $item->id) }}" onclick="return confirm('Yakin Data Mau Dihapus?')"><span class="fa fa-trash" style="color: red"></span></a>
                      </td>
                  </tr>
              @endforeach
              </tbody>
